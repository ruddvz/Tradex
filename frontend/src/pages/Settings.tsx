      ...
      <div className="pt-16 p-6">
        <div className="max-w-3xl mx-auto space-y-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {brokers.map(b => (
                <div key={b.name} className={clsx(
                  ...
                  b.connected ? 'border-brand-500/30 bg-brand-500/5' : 'border-surface-border bg-dark-300 hover:bg-surface-light'
                )}>
                  ...
                  {b.connected && <CheckCircle2 className="w-3.5 h-3.5 text-brand-400 ml-auto" />}
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="card p-6">
            ...
            <button className="btn-primary mt-4">Save Risk Settings</button>
          </div>
